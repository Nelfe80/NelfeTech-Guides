...
Everything is measured **inside the game's memory** (`.MEM` signals). Scorekeeping is automatic and cheating impossible.
...
- **Automatic fairness**: a challenge played with fewer than **2 real participants** (START pressed) is **never counted**. Your cups keep their value.
