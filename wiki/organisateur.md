...
Tout est mesuré **dans la mémoire du jeu** (signaux `.MEM`). Le pointage est automatique et la triche impossible.
...
- **Équité automatique** : un challenge joué à moins de **2 participants réels** (START appuyé) n'est **jamais comptabilisé**. Vos coupes gardent leur valeur.
